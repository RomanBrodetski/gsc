    ...
    describe "Admin" do
      describe "sliders" do
        ...
        describe "sliders list" do
          before do
            FactoryGirl.create(:slider, :headline => "UniqueTitleOne")
            FactoryGirl.create(:slider, :headline => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:slider, :headline => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:slider, :headline => "A headline") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:slider, :headline => "UniqueTitleOne") }
